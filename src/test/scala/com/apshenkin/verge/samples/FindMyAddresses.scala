package com.apshenkin.verge.samples

import com.apshenkin.verge.Base58.Prefix
import com.apshenkin.verge.{Base58, Base58Check, Crypto, DeterministicWallet, MnemonicCode, Script}
import com.apshenkin.verge.Crypto.PublicKey
import com.apshenkin.verge.Crypto.PublicKey
import com.apshenkin.verge.DeterministicWallet._
import com.apshenkin.verge.{Base58, Base58Check, Crypto, DeterministicWallet, MnemonicCode, Script}
...
object FindMyAddresses extends App {
  ...
  def address(pub: PublicKey): String = Base58Check.encode(if (testnet) Prefix.ScriptAddressTestnet else Base58.Prefix.ScriptAddress, Crypto.hash160(Script.write(Script.pay2wpkh(pub))))
