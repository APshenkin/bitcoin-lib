...
import com.apshenkin.verge.{Block, DeterministicWallet}
import com.apshenkin.verge.DeterministicWallet.ExtendedPublicKey
import com.apshenkin.verge._
...
object KeysFromXpub extends App {
  ...
  def deriveAddresses(xpub: String) = {
    val (prefix, master) = ExtendedPublicKey.decode(xpub)
    prefix match {
