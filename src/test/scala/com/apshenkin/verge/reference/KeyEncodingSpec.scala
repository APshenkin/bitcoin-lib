package com.apshenkin.verge.reference

import java.io.InputStreamReader

import com.apshenkin.verge.Crypto.PrivateKey
import com.apshenkin.verge.{Base58, Base58Check, Bech32, BinaryData, OP_CHECKSIG, OP_DUP, OP_EQUAL, OP_EQUALVERIFY, OP_HASH160, OP_PUSHDATA, Script}
...
import com.apshenkin.verge.{Base58, Base58Check, Bech32, OP_CHECKSIG, OP_DUP, OP_EQUAL, OP_EQUALVERIFY, OP_HASH160, Script}
...
object KeyEncodingSpec {
  def isValidBase58(input: String): Boolean = Try {
    ...
    prefix match {
      case Prefix.SecretKey | Base58.Prefix.SecretKeyTestnet => Try(PrivateKey(bin)).isSuccess
